...
Future<Map<String, dynamic>> getDefaultPreferences() async {
  return {
    ...
    "showPlannedVsActualFullScreen": true,
    "showNetWorth": false,
    ...
    "hasSignedIn": false,
    "serverUrl": "",
    // Backup destination -- "server" (this fork's own server, default) or
    // "webdav" (e.g. Nextcloud). See specs/03-stage-1-kill-google.md.
    // Deliberately independent of sync, which always uses "server".
    "backupTarget": "server",
    "webdavUrl": "",
    "webdavUsername": "",
    "webdavPassword": "",
    "webdavFolder": "cashew-backups",
