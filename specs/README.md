...
| [06-shared-household-data.md](06-shared-household-data.md) | Datasets, personal budgets, per-user view settings. Describes what shipped rather than a design. |
...
and their files record how — `BL-001` (category-locked budgets), `BL-002` (onboarding), `BL-004`
(public README), `BL-006` (per-period budget amounts), `BL-007` (fork-owned translations).
